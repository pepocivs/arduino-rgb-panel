...
void loop() {
  ...
  switch (programNo) {
    case 1:
      showAnimation(christmas, christmasFrames, 300);
      showAnimation(christmas2, christmas2Frames, 300);
      break;
    case 2:
      showAnimation(christmas02, christmas02Frames, 300);
      showAnimation(christmas022, christmas022Frames, 300);
      break;
    default:
      FastLED.clear();
      break;
